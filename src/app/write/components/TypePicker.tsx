/**
 * TypePicker.tsx — 类型选择弹窗
 * [核心职责] 显示所有可用的块类型列表，支持搜索过滤，标记当前选中类型和ordered状态
 * [Android 类比] BottomSheet Dialog，用于切换块类型
 */

"use client";

import { useState, useEffect, useRef, type FC } from "react";
import { BLOCK_TYPES, type BType } from "../types";
...
export const TypePicker: FC<Props> = ({ open, position, onSelect, onClose, currentType, ordered }) => {
